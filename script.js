// default as chennai
fetch(
  "https://api.openweathermap.org/data/2.5/weather?q=chennai&appid=de63028c12f89f320c07707ea331338a"
)
  ...
  try {
    ...
    if (cityName) {
      const resp = await fetch(
        `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=de63028c12f89f320c07707ea331338a`
      );
